              ...
              <div className="grid ">
                <div className="align-middle sm:pl-8">
                  ...
                  <p className="text-lg mt-8 xxl:text-xl max-w-[550px] text-gray-600">
                    ...
                    where exceptional web development meets creative innovation.
                    Transform your digital presence with our cutting-edge
                    solutions tailored to elevate your brand and captivate your
                    audience.
                  </p>
                  {/* </MotionDiv> */}
                </div>
